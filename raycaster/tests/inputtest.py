...
class DummyPlayer:
    def __init__(self):
        self.actions = []
    def move_forward(self): self.actions.append("forward")
    def move_backward(self): self.actions.append("backward")
    def strafe_left(self): self.actions.append("left")
    def strafe_right(self): self.actions.append("right")
    def turn_left(self): self.actions.append("turn_left")
    def turn_right(self): self.actions.append("turn_right")
